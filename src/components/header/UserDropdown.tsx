...
export default function UserDropdown() {
  ...
  }, [hasAccounts, accounts, currentAccountId]);
  ...
  const handleSaveAccount = async () => {
    ...
    try {
      await axios.post(
        "http://localhost:8080/api/auth/select-account",
  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center text-gray-700 px-10 py-2 rounded-full bg-white dropdown-toggle dark:text-gray-400"
      >
      ...
      >
        ...
        {hasAccounts && (
          <DropdownItem
            tag="button"
            className="flex items-center gap-3 px-3 py-2 mt-3 bg-c font-medium text-blue-600 rounded-lg group text-theme-sm hover:bg-blue-50 hover:text-blue-700 dark:text-blue-400 dark:hover:bg-white/5 dark:hover:text-blue-300"
